...
export default function Checkout() {
  ...
  return (
    <div className="min-h-screen bg-[#e6f7e2] p-8 md:p-20 pt-6">
      <h1 className="text-3xl font-bold text-[#5a6341] -mt-4 mb-8 text-center">
        Checkout
      </h1>

      <div className="grid md:grid-cols-2 gap-16 max-w-6xl mx-auto mt-16">
        <form
          onSubmit={handleSubmit}
          className="bg-white p-6 rounded-lg shadow-xl shadow-[#5a6341] border border-[#6f775b] space-y-5 text-[#5a6341] w-full"
        >
          {[
